...
const Skeleton = () => {
  ...
  return (
    <div className="p-8 overflow-hidden h-full relative flex items-center justify-center">
      ...
      <div className="h-40 w-px absolute top-20 m-auto z-40 bg-gradient-to-b from-transparent via-orange-400 to-transparent animate-move">
    ...
    <div className="absolute inset-0">
      {stars.map((star, i) => (
        <motion.span
          ...
          animate={{
            top: `calc(${star.topEnd}% + ${star.move}px)`,
            left: `calc(${star.leftEnd}% + ${star.move}px)`,
...
export const CardSkeletonContainer = ({
  ...
  return (
    <div
      className={cn(
        "h-36 md:h-[18rem] rounded-xl z-40",
        className,
        showGradient &&
