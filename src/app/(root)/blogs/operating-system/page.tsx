...
const HOST = "basics-of-operating-system.hashnode.dev";

export const metadata: Metadata = {
  title: "Operating System Blogs",
  description:
    "Foundational notes on processes, memory management, file systems, and how software talks to hardware.",
};
