...
const HOST = "next-wave.hashnode.dev";

export const metadata: Metadata = {
  title: "Next.js Blogs",
  description:
    "Notes and tutorials on Next.js, the App Router, and building fast, SEO-friendly React applications.",
};
    ...
    <div className="pt-16">
      <section className="container mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="mx-auto max-w-4xl text-center mb-16">
          <SectionHeading title="Next.js Blogs" highlighter="Blogs" />
