...
\begin{itemize}[leftmargin=0.15in, label={}]
  \small{\item{
        ...
        \vspace{3pt}\textbf{Libraries/Frameworks}{: \hfill React.js, Next.js, Node.js, Redux, Zod, React Query, Tailwind, Shadcn UI, Bootstrap, Apexcharts, Firebase \hfill} \\
        \vspace{3pt}\textbf{Databases/ORM}{: \hfill MySQL, MongoDB, NoSQL, Redis \hfill} \\
        \vspace{3pt}\textbf{Platforms/Tools}{: \hfill Git, GitHub, npm, pnpm, Cursor, Yarn, Vite, Vercel, V0, Netlify, Postman, Figma \hfill} \\
        \vspace{3pt}\textbf{Other}{: \hfill WebSocket, GitHub Pages, REST API, Swagger, Context API, State Management, Agile Collaboration \hfill} \\
        }}
\end{itemize}
